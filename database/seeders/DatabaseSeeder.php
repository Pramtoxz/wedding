...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $wedding = Wedding::create([
            'user_id' => $user->id,
            'slug' => 'dinda-fauzan-' . Str::random(6),
            'bride_name' => 'Adinda Dwi Lestari',
            'bride_father_name' => 'Bapak Jokowi',
            'bride_mother_name' => 'Ibu Megawati',
            'groom_name' => 'Julio Fauzan',
            ...
            'theme_primary_color' => '#355872',
            'theme_secondary_color' => '#7AAACE',
            'theme_accent_color' => '#9CD5FF',
