  ...
  <AppLayout>
    <div class="container mx-auto px-4 py-6 max-w-3xl">
      <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold">Edit Undangan Pernikahan</h1>
        <p class="text-sm text-muted-foreground">Update detail undangan pernikahan Anda</p>
      </div>
      ...
      <form @submit.prevent="submit" class="space-y-6">
        <Card>
          ...
          <CardContent class="space-y-4">
            ...
            <div class="space-y-2">
              ...
              <div v-if="wedding.bride_photo" class="mb-2">
                <img :src="`/storage/${wedding.bride_photo}`" class="w-32 h-32 object-cover rounded-lg" />
              </div>
            ...
            <div class="space-y-2">
              ...
              <div v-if="wedding.groom_photo" class="mb-2">
                <img :src="`/storage/${wedding.groom_photo}`" class="w-32 h-32 object-cover rounded-lg" />
              </div>
        ...
        <Card>
          ...
          <CardContent class="space-y-4">
            <div class="space-y-2">
              ...
              <div v-if="wedding.cover_image" class="mb-2">
                <img :src="`/storage/${wedding.cover_image}`" class="w-32 h-32 object-cover rounded-lg" />
              </div>
        ...
        <div class="flex gap-2">
          ...
          <Button as-child variant="outline" type="button">
            <Link :href="`/admin/weddings/${wedding.id}`">Batal</Link>
          </Button>
        </div>
      </form>
    </div>
...
const form = useForm({
  ...
  bride_father_name: props.wedding.bride_father_name || '',
  bride_mother_name: props.wedding.bride_mother_name || '',
  bride_photo: null as File | null,
  groom_name: props.wedding.groom_name,
  groom_father_name: props.wedding.groom_father_name || '',
  groom_mother_name: props.wedding.groom_mother_name || '',
...
const submit = () => {
  if (form.cover_image || form.bride_photo || form.groom_photo) {
    form.transform((data) => ({
      ...data,
      _method: 'PUT'
    })).post(`/admin/weddings/${props.wedding.id}`, {
      forceFormData: true
    })
  } else {
